...
function Contact() {
  return (
    <section id="contact" className="py-28 border-t border-white/6 bg-surface/40">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <Reveal type="up">
          <h2 className="font-display text-3xl sm:text-4xl font-semibold tracking-tight mb-2">Start a project</h2>
          <p className="text-fg-dim max-w-md mb-10">Tell me a bit about what you need — I reply within a day, usually sooner.</p>
        </Reveal>
